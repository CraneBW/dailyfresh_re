...
# 指定收集静态文件的路径
STATIC_ROOT='/home/crane/PycharmProjects/dailyfresh/static_second'
...
EMAIL_PORT = 25
# 发送邮件的邮箱
EMAIL_HOST_USER = '3116767084@qq.com'
# 在邮箱中设置的客户端授权密码
EMAIL_HOST_PASSWORD = '1234'
# 收件人看到的发件人
EMAIL_FROM = '宁大生鲜<3116767084@qq.com>'
...
# FDFS_URL = 'http://192.168.137.174:8888/'  # 使用局域网 IP
# FDFS_URL = 'http://file.toplabs.com:80/'  # 使用域名（需配置 hosts）
FDFS_URL = ''
# 全文检索框架的配置
